export const heritiges = [
  {
    pfsLegal: true,
    ancestryName: "Dwarf",
    ability: {
      abilityActions: "Reaction",
      abilitySource: "Core Rulebook pg. 35",
      Trigger:
        " You attempt a saving throw against a magical effect, but you haven't rolled yet.",
      abilityName: "Call on Ancient Blood ",
      abilitySourceLink:
        "https://paizo.com/products/btq01y0k?Pathfinder-Core-Rulebook",
    },
    name: "Ancient-Blooded Dwarf",
    sourceLink: "https://paizo.com/products/btq01y0k?Pathfinder-Core-Rulebook",
  ...
  },
  {
    ...
    ancestryName: "Dwarf",
    ability: {
      abilityTraits: ["Primal", "Source"],
      abilityActions: "Two Actions",
      Frequency: " once per day",
      abilitySource: "Character Guide pg. 19",
      abilitySourceLink:
        "https://paizo.com/products/btq01zpx?Pathfinder-Lost-Omens-Character-Guide",
      abilityName: "Energy Emanation ",
    },
  ...
  },
  {
    ...
    source: "Core Rulebook pg. 43",
    description:
      "The blood of the fey is so strong within you that you're truly one of them. You gain the fey trait, in addition to the gnome and humanoid traits. Choose one cantrip from the ",
  },
  {
    pfsLegal: true,
    ancestryName: "Gnome",
    ...
    description:
      "You see all colors as brighter, hear all sounds as richer, and especially smell all scents with incredible detail. You gain a special sense: ",
  },
  {
    pfsLegal: true,
    ancestryName: "Gnome",
  ...
  },
  {
    ...
    description:
      "Your ancestors have traveled from place to place for generations, never content to settle down. You gain two additional languages of your choice, chosen from among the common and uncommon languages available to you, and every time you take the ",
  },
  {
    pfsLegal: true,
    ancestryName: "Halfling",
  ...
  {
    pfsLegal: true,
    ancestryName: "Hobgoblin",
    ability: {
      abilityActions: "Reaction",
      abilitySource: "Character Guide pg. 49",
      Trigger:
        " You attempt a saving throw against a magical effect but haven't rolled yet.",
      abilityName: "Resist Elf Magic ",
      abilitySourceLink:
        "https://paizo.com/products/btq01zpx?Pathfinder-Lost-Omens-Character-Guide",
    },
  ...
  },
  {
    ...
    ability: {
      abilityActions: "Two Actions",
      abilitySource: "Character Guide pg. 57",
      abilityName: "Threatening Approach ",
      abilitySourceLink:
        "https://paizo.com/products/btq01zpx?Pathfinder-Lost-Omens-Character-Guide",
    },
